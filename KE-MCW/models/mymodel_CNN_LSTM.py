...
class myModel(object):
    ...
    def __init__(self,
        ...
        with tf.compat.v1.variable_scope('output_sy'):
            ...
            rnn_conv_outputs1 = tf.reshape(self.rnn_conv_outputs1, [-1, nh1])  # rnn_ori_outputs1 (?, 300)
        ...
        with tf.compat.v1.variable_scope('output_sz'):
            ...
            rnn_conv_outputs2 = tf.reshape(self.rnn_conv_outputs2, [-1, nh2])  # rnn_ori_outputs2 (?, 300)
